...
$query = mysqli_query($con, "SELECT * FROM data_paketharga WHERE id='$data'") or die(mysqli_error($con));
    ...
    <body id="top" class="join-page">
        ...
        <div class="jumbotron full-transparent mb-0">
            <div class="container">
                ...
                <hr class="my-5">
                <div>
                    <form action="../proses_pg/edit_paket.php" class="container pt-2" data-spy="scroll" data-target="#navbar">
...
<script>
    var elm = document.getElementById("").classList.add("isActive")
</script>
</html>