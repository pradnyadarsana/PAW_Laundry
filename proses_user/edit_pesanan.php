...
if(isset($_POST['update']) && !empty($_POST['id'])){
    ...
    $query = mysqli_query($con,"UPDATE data_pesanan SET username='$username',telepon='$telepon',alamat='$alamat',berat='$berat',harga='$total_harga',status='$status', tanggal='$tanggal' WHERE id='$id' ")or die(mysqli_error($con));
    if($query){
